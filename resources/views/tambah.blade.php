...
<body>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						...
						<li><a href="http://localhost/laravel1/public/tambah" class="act">Tambah Barang Baru</a></li>							
						<!-- Mega Menu -->
						<li class="dropdown">
 ...
 <table width="454" height="285" border="0" style='border-collapse:collapse'>
    ...
    <td><input type='number' name="id_kategori" required="required" style='width:290px' min=1></td>
	</tr>
	
	<tr>
    <td>Barang</td>
    <td><div align="center">:</div></td>
    <td><input type='text' name="barang" required="required" style='width:290px' autocomplete=off></td>
	</tr>
	
	<tr>
    <td>Harga</td>
    <td><div align="center">:</div></td>
    <td><input type='number' name="harga" required="required" style='width:290px' autocomplete=off></td>
	</tr>
	
	<tr>
    <td>Stok</td>
    <td><div align="center">:</div></td>
    <td><input type='number' name="stok" required="required" style='width:290px' autocomplete=off></td>
	</tr>
	
	<tr>
    <td>Berat</td>
    <td><div align="center">:</div></td>
    <td><input type='text' name="berat" required="required" style='width:290px' autocomplete=off ></td>
	</tr>
	
	<tr>
    <td>Keterangan</td>
    <td><div align="center">:</div></td>
    <td><input type='text' name="keterangan" required="required" style='width:290px' autocomplete=off></td>
	</tr>
	
	<tr>
    <td>Gambar</td>
    <td><div align="center">:</div></td>
    <td><input type='file' name="gambar" required="required" style='width:290px' id="gambar"></td>
	</tr>
