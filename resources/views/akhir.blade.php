			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						...
						<li><a href="{{url('akhir')}}" class="act">Check Out</a></li>
...
<marquee width=15%>Hasil Pembelian</marquee>
</br>
<center>
<td><a href="{{url('tdkjadi')}}">Hapus Semua</a>
</br>
</br>
<?php
		$g=0;
		...
		echo "<table border=1><tr><td>Barang</td><td>Jumlah Barang</td><td>Harga Satuan</td><td>Total</td><td>Remove</td></tr>";
		while($i<sizeof($d)){
			...
			echo "<td><input type='text' disabled value='".json_encode($d[$i][2])."'></td>";
			?><td><center><a href="{{url('cartdel',$i)}}">X</a></center></td><?php
			$g+=json_encode($d[$i][2]);
		...
		echo "<tr><td colspan=3></td><td>".$g."</td>";
		echo "</table>";
		?>
		...
		{{ csrf_field() }}
			...
			<tr>
			<input type='text' value=<?php echo $g;?> name='total' hidden>
			
			<td><a href="{{url('bayar')}}" target="_blank" rel="nofollow"><button class='btn btn-primary'>Bayar</button></a></td>
</tr></table>
<div>
