			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						...
						<li><a href="http://localhost/laravel1/public/cekpembayaran" class="act">Pembayaran</a></li>
...
@foreach($barang as $p)
	...
	<td><?php echo $p->propinsi;?></td>
	<td><?php echo $p->kota;?></td>
	<td><?php echo $p->kecamatan;?></td>
	<td><?php echo $p->alamat;?></td>
	<td><?php echo $p->bukti;?> <center><image src="uploadgambar/{{ $p->bukti }}" width="50px" height="50px" style="border:0px solid black"></center></td>
	<td><a href="/laravel1/public/lihatbarang/{{ $p->id_pesan }}">Invoice</a></td>
	<td><a href="/laravel1/public/bayar1/{{ $p->id_pesan }}/{{ $p->id_user }}/{{ $p->tgl_bayar }}/{{ $p->bukti }}/{{ $p->jmlh_bayar }}"> &#8730; </a></td>
	</tr>
	@endforeach
	</center>
</table>
	...
	Data Per Halaman Pembayaran : {{ $barang->perPage() }} <br/>
