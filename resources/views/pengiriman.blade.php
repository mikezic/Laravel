...
<body>
 ...
 <table width="454" height="285" border="0" style='border-collapse:collapse'>
    ...
    <td>Nama Kurir</td>
    <td><div align="center">:</div></td>
    <td><input type='number' name="stok" required="required" style='width:290px'></td>
	</tr>
	
	<tr>
    <td>Bukti Terima Barang</td>
    <td><div align="center">:</div></td>
    <td><input type='text' name="berat" required="required" style='width:290px'></td>
	</tr>
