...
<body> 
	...
	<div class="banner banner2">
		<div class="container">
			<h2>Get 20% FREE<span>HomeTeater</span> For 2 <i>Minimum Purchase</i></h2> 
		</div>
	</div> 
	<!-- breadcrumbs -->
	<div class="breadcrumb_dress">
		<div class="container">
			<ul>
				<marquee width="100%">HomeTeater Polytron Hemat 20% </marquee>
			</ul>
		</div>
	</div>
	<!-- //breadcrumbs --> 
					...
					<h3>Price</h3>
						<div class="w3ls_mobiles_grid_left_grid_sub">
							<div class="ecommerce_color ecommerce_size">
								<ul>
									<li><a href="/laravel1/public/sortir26/home_teater/asc">Dari Terendah</a></li>
									<li><a href="/laravel1/public/sortir26/home_teater/desc">Dari Termahal</a></li>
								</ul>
							</div>
						</div>
				</div>
