...
<h2>Data Pembayaran Baru</h2>
 <table width="454" height="285" border="0" style='border-collapse:collapse'>
	<form action="{{url('pembayaranbaru1')}}" method="POST" enctype="multipart/form-data">
		{{ csrf_field() }}
	
	<tr>
    <td>Tanggal Bayar</td>
    <td><div align="center">:</div></td>
    <td><input type='date' name="tgl_bayar" required="required" style='width:290px'></td>
	</tr>
	
	<tr>
    <td>Jumlah Bayar</td>
    <td><div align="center">:</div></td>
    <td><input type='number' name="jmlh_bayar" required="required" style='width:290px'></td>
	</tr>
	
	<tr>
    <td>No User</td>
    <td><div align="center">:</div></td>
    <td><input type='number' name="id_user" required="required" style='width:290px'></td>
	</tr>
    ...
    <td>Nama User</td>
    <td><div align="center">:</div></td>
    <td><input type='text' name="nama" required="required" style='width:290px'></td>
	</tr>
    ...
    <td>Barang</td>
    <td><div align="center">:</div></td>
    <td><input type='text' name="barang" required="required" style='width:290px'></td>
	</tr>
	
	<tr>
    <td>Jumlah</td>
    <td><div align="center">:</div></td>
    <td><input type='number' name="jumlah" required="required" style='width:290px'></td>
	</tr>
	
	<tr>
    <td>Harga</td>
    <td><div align="center">:</div></td>
    <td><input type='number' name="harga" required="required" style='width:290px'></td>
	</tr>
 </table>
